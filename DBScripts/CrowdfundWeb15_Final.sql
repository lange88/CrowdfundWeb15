...
-- Supporter_Suggestion [rel11]
alter table "public"."suggestion"  add column  "user_oid"  int4;
alter table "public"."suggestion"   add constraint fk_suggestion_user foreign key ("user_oid") references "public"."user" ("oid");


-- Campaigner_Suggestion [rel12]
alter table "public"."suggestion"  add column  "user_oid_2"  int4;
alter table "public"."suggestion"   add constraint fk_suggestion_user_2 foreign key ("user_oid_2") references "public"."user" ("oid");


-- Suggestion_Campaign [rel14]
alter table "public"."suggestion"  add column  "campaign_oid"  int4;
alter table "public"."suggestion"   add constraint fk_suggestion_campaign foreign key ("campaign_oid") references "public"."campaign" ("oid");
...
alter table "public"."question"   add constraint fk_question_user foreign key ("user_oid") references "public"."user" ("oid");


-- Question_Campainer [rel9]
alter table "public"."question"  add column  "user_oid_2"  int4;
alter table "public"."question"   add constraint fk_question_user_2 foreign key ("user_oid_2") references "public"."user" ("oid");


-- User.reputation [User#att23]
create view "public"."user_reputation_view" as
select AL1."oid" as "oid", count(distinct AL3."user_oid") as "der_attr"
from  "public"."user" AL1 
               left outer join "public"."campaign" AL2 on AL1."oid"=AL2."user_oid"
               left outer join "public"."user_campaign_vote" AL3 on AL2."oid"=AL3."campaign_oid"
group by AL1."oid";
...
-- User.wisdom [User#att24]
create view "public"."user_wisdom_view" as
select AL1."oid" as "oid", sum(AL4."der_attr") as "der_attr"
from  "public"."user" AL1 
               left outer join "public"."pledge" AL2 on AL1."oid"=AL2."user_oid"
               left outer join "public"."contribution" AL3 on AL2."contribution_oid"=AL3."oid"
               left outer join "public"."campaign_quality_view" AL4 on AL3."campaign_oid"=AL4."oid"
group by AL1."oid";


-- Campaign.progress [ent10#att27]
create view "public"."campaign_progress_view" as
select AL1."oid" as "oid", sum(AL3."amount") as "der_attr"
from  "public"."campaign" AL1 
               left outer join "public"."contribution" AL2 on AL1."oid"=AL2."campaign_oid"
               left outer join "public"."pledge" AL3 on AL2."oid"=AL3."contribution_oid"
